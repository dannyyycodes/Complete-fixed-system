...
def setup_initial_credentials():
    """Setup initial credentials from environment or defaults"""
    cm = CredentialManager()
    
    credentials = {
        'kie': os.getenv('KIE_API_KEY', 'b6950bc9ee85f941ecb523ce34efb4a0'),
        'blotato': os.getenv('BLOTATO_API_KEY', 'blt_sHvjFzyhDdrJOVlCTFhV+AlHMZyeRXjE6reQL52Qxmw='),
        'openrouter': os.getenv('OPENROUTER_API_KEY', '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'),
    }
